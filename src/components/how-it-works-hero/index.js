...
const ItemsContainer = styled.div`
    ...
    gap: 58px;
    margin-bottom: 44px;
    ${makeMediaQueryMax(1000, 'flex-direction: column; gap: 50px; margin-bottom: 50px;')}
`
...
export const HowItWorksHero = (props: Props) => {
    ...
    return <Container>
        ...
        <ButtonWithCaret textStyle={makeMediaQueryMax(1000, Typographies.TextLarge)} buttonBackgroundColor={Colors.White} buttonTextColor={Colors.Blue} href={Routes.HowItWorks} buttonText="More about selling with us" />
    </Container>
}
